...
import co.com.choucair.certification.tasks.LlenarFinal;
...
public class Responder implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        String Boton_Final = Text.of(Final.BOTON_COMPLETAR).viewedBy(actor).asString();
        return datos.get(0).getStrTextoF().equals(Boton_Final);
    }
}
